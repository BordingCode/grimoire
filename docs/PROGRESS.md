...
- **Still open:** no light-mode scene variant (light = plain by design). Minor: SW is registered as `sw.js?v=47` (stale literal, harmless — `reg.update()` re-fetches regardless).
