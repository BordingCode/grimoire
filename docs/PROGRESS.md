...
- **Still open:** no light-mode scene variant (light = plain by design). The cache-first SW means new versions only arrive via the update prompt (by design / offline-first).
